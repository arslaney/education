...
window.REHBERLI_GOREVLER = {
  excel_analiz:{
    ...
    arac:"Claude",
    veriAnahtari:"excel_calisan",
    veriEtiket:"📊 60 çalışanlık veri tablosu (departman, performans, memnuniyet, ayrılma riski)",
    senaryo:"Elinde 60 çalışanlık bir veri tablosu var: departman, performans, memnuniyet, ayrılma riski. Yöneticin 'bu veriden ne çıkıyor?' diye soruyor. Bu tabloyu sana hazır verdik — senin işin doğru soruyu sormak.",
    adimlar:[
      "Aşağıda veri tablosunun hazır olduğunu gör (yüklemene gerek yok)",
      "Bu veriyi analiz edecek güçlü bir prompt yaz",
      "Örnek: 'Bu çalışan verisini analiz et. Hangi departmanda ayrılma riski yüksek? Memnuniyet ile performans arasında ilişki var mı? 5 maddede özetle ve yüksek riskli çalışanlar için 3 öneri ver.'",
      "Gönder — platform veriyi Claude'a iletecek, gerçek analizi göreceksin",
    ],
    promptYer:"Veriyi nasıl analiz etmesini istediğini yaz...",
    gorevDeger:"Kullanıcı bir çalışan verisi analizi için prompt yazdı. Bu promptun kalitesini değerlendir: net mi, doğru analiz yönü veriyor mu, somut çıktı isteği var mı?",
  },
  pdf_notebook:{
    rozet:"GERÇEK İŞ · PROSEDÜR",
    baslik:"Bir prosedüre kaynaklı soru sor",
    arac:"Claude",
    veriAnahtari:"pdf_izin",
    veriEtiket:"📄 Şirket izin ve devamsızlık prosedürü (resmi metin)",
    senaryo:"Bir çalışan 'doğum iznim kaç gün?' diye sordu. Yanıtın resmi prosedüre dayanmalı, uydurma olmamalı. Prosedür metnini sana hazır verdik — doğru soruyu sor, cevap belgeden gelsin.",
    adimlar:[
      "Aşağıda resmi prosedür metninin hazır olduğunu gör",
      "Cevabın MUTLAKA bu metne dayanmasını isteyen bir prompt yaz",
      "Örnek: 'Sana verdiğim prosedür metnine göre doğum izni kaç gündür? Hangi maddeye dayandığını da belirt. Sadece bu metindeki bilgiyi kullan, uydurma.'",
      "Gönder — Claude yalnızca verdiğin metinden, kaynak göstererek cevaplayacak",
    ],
    promptYer:"Prosedüre dayalı sorunu yaz (kaynak göstermesini iste)...",
    gorevDeger:"Kullanıcı, kaynak metne dayalı cevap almak için prompt yazdı. Değerlendir: cevabın belgeye dayanmasını ve kaynak gösterilmesini net biçimde istiyor mu, uydurmayı engelliyor mu?",
  },
  word_sunum:{
    rozet:"GERÇEK İŞ · SUNUM",
    baslik:"Dağınık notları sunuma çevir",
    arac:"Claude",
    veriAnahtari:"word_notlar",
    veriEtiket:"📝 Dağınık oryantasyon notları (ham metin)",
    senaryo:"Elinde dağınık oryantasyon notları var. Bunlardan sunulabilir, derli toplu bir sunum taslağı çıkarman lazım. Notları sana hazır verdik — onları işe yarar bir yapıya dönüştürecek promptu sen yaz.",
    adimlar:[
      "Aşağıda dağınık notların hazır olduğunu gör",
      "Bunları bir sunum taslağına dönüştürecek prompt yaz",
      "Örnek: 'Sana verdiğim dağınık notları, 6 slaytlık bir oryantasyon sunumu taslağına dönüştür. Her slayt için başlık + 3 madde + konuşmacı notu ver.'",
      "Gönder — Claude sana sunulabilir bir taslak üretecek",
    ],
    promptYer:"Notları nasıl bir sunuma dönüştürmesini istediğini yaz...",
    gorevDeger:"Kullanıcı, dağınık notları sunuma çevirmek için prompt yazdı. Değerlendir: çıktı yapısını (slayt, başlık, madde) net tanımlıyor mu, kullanışlı bir sonuç verir mi?",
  },
};

// Mesleğe göre rehberli görev seçimi
